...
VECHICLE_ID = 1
CONTROLLER_LISTENER_WS_IP = '127.0.0.1'
CONTROLLER_LISTENER_WS_PORT = 6689

SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480

MUTE_REPETITIVE_ERRORS_AFTER_OCURRENCES = 10
...
METRICS_CLOUD_UPDATE_EVERY_SEC = 0.04
...
PROXYMITY_SENSOR_UART = "/dev/ttyACM0"
